                                                ...
                                                <div class="w-75 m-auto">
                                                        <div class="card">
                                                           <div class="card-body">
                                                                <div class="mb-20">
                                                                        <div class="row">
                                                                                <label class="col-sm-4 col-lg-2 col-form-label">Mặt Hàng</label>
                                                         ...
                                                         <button type="submit" class="button-submit btn btn-info btn-block"> Thêm mặt hàng</button>
                                                </div>
                                        </div>
         ...
         var data={
          ...
          .then(response=> {
              ...
              this.$notify({
                            ...
                            title: 'Thành công',
                            type: 'success',
                            text: 'Mặt hàng đã được thêm mới',
                            speed: 1000,
                                duration: 500,
                    })
          })
